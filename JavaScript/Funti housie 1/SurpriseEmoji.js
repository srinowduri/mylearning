...
function getAlphabet(){
	...
	if(newAlphaList.length < alphabetsList.length){
		...
		newAlphaList.push(randomAlphaIndex);
			...
			//prevAlphaIndex = prevAlpha -1;
			document.getElementById(prevAlphaId).innerHTML = prevAlpha;
			//document.getElementById(prevAlpha).style.backgroundColor = "skyblue";
			document.getElementById(prevAlphaId).style.backgroundColor = "orange";
	...
	//alphabetsList.splice(randomAlphaIndex,1);
}	
...
function getEmoji(){
	...
	/* if(newEmojiList.length > 0){
		if(newEmojiList.length === 75){
			document.getElementById("counter").innerHTML = "All Done";
		} else {
 ...
 */
	if(randomEmojiNumberList.length === 0){
		...
		setTimeout(function() {
			...
			let path = 'C://Users/vatsa/HousieTickets/Emoji/' +randomEmoji+'.png';
...
function getNumber(){
	...
	if(tempNumberList.length <90){
		...
		//numberList.splice(randomNumberIndex,1);
	} 	
			...
			//document.getElementById("num").innerHTML = disable;			
		} 
